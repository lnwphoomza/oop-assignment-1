...
def test_library_system():
    ...
    # Test 1: Add Books
    print("\n--- TEST 1: Adding Books ---")
    lib1.add_book(1, "Python Crash Course", "Eric Matthes", 3)
    lib1.add_book(2, "Clean Code", "Robert Martin", 2)
    lib1.add_book(3, "The Pragmatic Programmer", "Hunt & Thomas", 1)
    lib1.add_book(4, "Design Patterns", "Gang of Four", 2)
    
    # Test 2: Add Members
    print("\n--- TEST 2: Registering Members ---")
    lib1.add_member(101, "Alice Smith", "alice@email.com")
    lib1.add_member(102, "Bob Jones", "bob@email.com")
    lib1.add_member(103, "Carol White", "carol@email.com")
    
    # Test 3: Display Available Books
    print("\n--- TEST 3: Display Available Books ---")
    lib1.display_available_books()
    
    # Test 4: Successful Book Borrowing
    print("\n--- TEST 4: Successful Borrowing ---")
    lib1.borrow_book(101, 1)  # Alice borrows Python Crash Course
    lib1.borrow_book(101, 2)  # Alice borrows Clean Code
    lib1.borrow_book(102, 1)  # Bob borrows Python Crash Course
    
    # Test 5: Display Member's Borrowed Books
    print("\n--- TEST 5: Display Member's Books ---")
    lib1.display_member_books(101)  # Alice's books
    lib1.display_member_books(102)  # Bob's books
    lib1.display_member_books(103)  # Carol's books (none)
    ...
    lib1.borrow_book(103, 3)  # Carol borrows the only copy of Pragmatic Programmer
    lib1.display_available_books()
    
    # Test 8: Try to Borrow Unavailable Book
    print("\n--- TEST 8: Attempting to Borrow Unavailable Book ---")
    lib1.borrow_book(102, 3)  # Bob tries to borrow unavailable book
    
    # Test 9: Borrowing Limit Test
    print("\n--- TEST 9: Testing Borrowing Limit (3 books max) ---")
    lib1.borrow_book(101, 4)  # Alice's 3rd book
    lib1.display_member_books(101)
    lib1.borrow_book(101, 3)  # Alice tries to borrow 4th book (should fail)
    
    # Test 10: Return Books
    print("\n--- TEST 10: Returning Books ---")
    lib1.return_book(101, 1)  # Alice returns Python Crash Course
    lib1.return_book(102, 1)  # Bob returns Python Crash Course
    lib1.display_member_books(101)
    lib1.display_available_books()
    
    # Test 11: Try to Return Book Not Borrowed
    print("\n--- TEST 11: Attempting Invalid Return ---")
    lib1.return_book(102, 2)  # Bob tries to return book he didn't borrow
    
    # Test 12: Return and Borrow Again
    print("\n--- TEST 12: Return and Re-borrow ---")
    lib1.return_book(103, 3)  # Carol returns Pragmatic Programmer
    lib1.borrow_book(102, 3)  # Bob borrows it
    lib1.display_member_books(102)
    
    # Test 13: Error Cases - Non-existent Member/Book
    print("\n--- TEST 13: Error Handling ---")
    lib1.borrow_book(999, 1)  # Non-existent member
    lib1.borrow_book(101, 999)  # Non-existent book
    lib1.return_book(999, 1)  # Non-existent member
    lib1.display_member_books(999)  # Non-existent member
